...
class _DynamicFormScreenState extends State<DynamicFormScreen> {
        ...
        onPopInvokedWithResult: (didPop, result) async {
          if (didPop) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text(
                  'لا يمكن الرجوع أثناء المعالجة. يرجى الانتظار حتى تنتهي المعالجة.',
                ),
  ...
  Widget _buildFolderProcessingWidget(BuildContext context) {
    return Obx(
      () => Card(
        // استخدام Card لإضافة خلفية وظل للـ widget
        elevation: 3,
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ClipRRect(
                        // لإضافة حواف دائرية لشريط التقدم
                        ...
                        child: LinearProgressIndicator(
                          value: folderController.totalCount.value > 0
                              ...
                              : 0,
                          backgroundColor:
                              Colors.blue.shade100, // لون خلفية فاتح
                      ...
                      Row(
                        ...
                        children: [
                          _buildStatText(
                            ...
                            label:
                                'نجاح: ${folderController.successCount.value}',
                            color: Colors.green.shade700,
                          ),
                          _buildStatText(
                            icon: Icons.cancel,
                            label:
                                'فشل: ${folderController.failureCount.value}',
                            color: Colors.red.shade700,
                          ),
                          _buildStatText(
                            icon: Icons.schedule,
                            label:
                                'معلق: ${folderController.pendingCount.value}',
                            color: Colors.orange.shade700,
                          ),
                          _buildStatText(
                            icon: Icons.info,
                            label:
                                'المتبقي: ${folderController.totalCount.value - folderController.processedCount.value}',
